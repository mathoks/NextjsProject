...
const ProductForm = ({data}) => {
  return (
    <div className='mx-auto flex flex-col space-y-2 bg-white'>
      ...
      <input type='text' className='p-2.5 bg-[#fcfaff]  border-l-4 border-[#6A0DAD]'/>
      </section>
        <section className='flex flex-col space-y-1'>
            <label htmlFor='address' className='font-semibold '>Product Description</label>
            <input name='text' className='p-2.5 bg-[#fcfaff]  border-l-4 border-[#6A0DAD]'/>
        </section>
        ...
        <section className='flex flex-col space-y-1'>
            ...
            <input type='number' className='p-2.5 bg-[#fcfaff]  border-l-4 border-[#6A0DAD]'/>
        </section>
