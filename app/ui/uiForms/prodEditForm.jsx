...
const ProdEditForm = ({data}) => {
    ...
    <div className='flex flex-col  p-4  text-base '>
      <form className='mx-auto space-y-4 w-full md:flex md:space-x-10' action={dispatch}>
     <ImageEdit data={prodImage} trigger = {toggleActive} hide={loading}/>
      ...
      <section className='no_border flex flex-col'>
        ...
        <input maxLength={200} name='description' defaultValue={null} onChange={handleFocus} onBlur={handleBlur} className='w-full py-1.5 placeholder:text-gray-500 ' placeholder={description}/>
        <pre className='text-slate-400  text-sm text-right '> </pre>
        </section>
