...
const BranchForm = () => {
  ...
  return (
    ...
    <section>
      ...
      <input onBlur={dispatch2} name='storename' className='p-2.5 bg-[#fcfaff] rounded-md ring-1 ring-[#a946f1]'/>
      <span id="customer-error"  aria-live="polite" className=" text-left" aria-atomic="true" >
        ...
        <section className='flex flex-col space-y-1'>
            ...
            <input name='address' onBlur={dispatch2} className='p-2.5 bg-[#fcfaff] ring-1 ring-[#a946f1] rounded-md'/>
            <span id="customer-error"  aria-live="polite" className=" text-left" aria-atomic="true" >
        ...
        <section className='flex flex-col space-y-1 pb-2'>
            ...
            <input name='tel' className='p-2.5 bg-[#fcfaff] rounded-md ring-1 ring-[#a946f1] rounded-md'/>
            <span id="customer-error"  aria-live="polite" className="text-left" aria-atomic="true" >
