...
const Ads = () => {
  return (
    <div className="flex  p-4 space-x-4 pb-1 overflow-x-scroll h-[16rem] w-full">
    <div className='w-[180px] relative flex flex-col rounded shadow-lg'>
    <Image
              src={Logo2}
              alt="pro"
              width={200}
            ...
            />
      <div className=" flex flex-col space-y-3 w-[180px] p-2">
              <div>
              ...
              <div className='w-[180px] rounded relative   shadow-lg'>
              <Image
              src={Logo}
              alt="pro"
              width={200}
              ...
              className="shrink-0 rounded-t-lg"
            />
      <div className="w-[180px]  flex flex-col space-y-3 p-2">
              <div>
                <p className=" w-3/4 overflow-ellipsis font-semibold text-sm">Shoe Luis</p>
              </div>
              <div>
              ...
              className="shrink-0 rounded-t-lg"
            />
      <div className=" w-[180px] pl-2 pr-2 flex flex-col space-y-3">
              <div>
                <p className=" w-3/4 overflow-ellipsis font-semibold text-sm">Shoe Luis</p>
              </div>
              <div>
